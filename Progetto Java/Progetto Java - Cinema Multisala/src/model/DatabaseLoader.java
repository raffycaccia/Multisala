...
public class DatabaseLoader {
	...
	public static ArrayList<Spettacolo> caricaSpettacoli() {
		...
		Spettacolo spett1 = new Spettacolo(new Data(2018, 12, 16, 20, 55), (float) 10.0, new Sala("A",10, 5, 5), new Film("Patate a mensaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","Horrorgjhjhkgjhjkjhjgkjgjhjkhjjhhjgghhghgghgjhjghkghgjghghjhghgggjhghghjgjhg jhgjhaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",10));
		Spettacolo spett2 = new Spettacolo(new Data(2018, 12, 14, 21, 50), (float) 10.0, new Sala("B",20, 10, 10), new Film("Polpette a mensa","Horror",10));
		Spettacolo spett3 = new Spettacolo(new Data(2018, 12, 13, 00, 04),
				(float) 10.0, new Sala("B",20, 10, 10),
		...
		Spettacolo spett4 = new Spettacolo(new Data(2018, 12, 16, 21, 50), (float) 10.0, new Sala("B",20, 15, 15), new Film("Polpette a mensa","Horror",10));
